<x-guest-layout>
    ...
    <form method="POST" action="{{ route('two-factor.verify.post') }}">
        ...
        <div class="mb-4">
            ...
            <x-text-input id="code" name="code" type="text" maxlength="6" autocomplete="one-time-code"
                class="block mt-1 w-full text-center tracking-widest text-lg" placeholder="000000" autofocus />
